...
//   )
    ...
    const onjoinUser = (event: { preventDefault: () => void; }) => {
        ...
        const customer = require('./userList.json');
        customer.push(newUser)
        console.log(customer);

        // const newUserList = userList.push.new d(newUser);
